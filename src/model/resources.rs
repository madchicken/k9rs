...
pub const RESOURCES: &[ResourceEntry] = &[
    ...
    ResourceEntry {
        display_name: "ServiceAccounts",
        api_name: "serviceaccounts",
        category: "Config",
    },
    // Network
    ResourceEntry {
    ...
    ResourceEntry {
        ...
        api_name: "persistentvolumes",
        category: "Storage",
    },
    ResourceEntry {
        display_name: "PersistentVolumeClaims",
        api_name: "persistentvolumeclaims",
        category: "Storage",
    },
    // Cluster
    ResourceEntry {
